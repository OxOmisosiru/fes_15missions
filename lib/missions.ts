...
export const missions: MissionDefinition[] = [
  ...
  },
  {
    ...
    description: "クリア条件：４の謎に正解すること\n\nX(@15missions) 上の投票によって、謎の左右二分割のうちどちらが与えられるかが決定されます。\n投票は8/22(土) 11:00-16:00 の期間で行われます。\n二分割された後の謎は8/22(土) 16:15頃、受付付近にて掲示します。\n解答判定は４の謎のみ行います。４の謎の解答が分かったらこのページにて送信してください。\n正誤判定には時間を要します。申し訳ございません。",
    image: "",
    answerType: "answer",
  },
  {
